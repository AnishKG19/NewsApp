...
export class News extends Component {
    ...
    async updateNews() {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=30be0f5de0564ff7b91a8a165b052cb5&page=${this.state.page}&pageSize=${this.props.pageSize}`;
